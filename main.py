...
2. Login page with security such as tokens
3. Personalised suggestions. - recommend stuff based on user preferences - link to userID
...
4. Genre Trends - Just query table and tally genres and order by popularity - can be for books or users - Some sort of true or false can be used to determine which table to take from. 
